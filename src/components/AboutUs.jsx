  ...
  return (
    <section id="about" className="py-24 px-4 md:px-12 bg-transparent max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#1E3A5F] mb-4 flex flex-col md:flex-row items-center justify-center gap-x-2 gap-y-1">
          <span>Welcome to</span>
          <DancingText text="Akshara High School" className="rainbow-school-text justify-center" />
        </h2>
